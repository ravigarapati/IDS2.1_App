...
import SensorCalibrationScreen from '../../src/pages/SensorCalibrationScreen';
...
describe('SensorCalibrationScreen screen', () => {

  it('Render SensorCalibrationScreen screen in Farenheit', () => {
    let component = render(
      <Provider store={store}>
        <SensorCalibrationScreen navigation={fakeNavigation} />
      </Provider>
    )
    expect(component).toBeDefined();
  });

  it('Render SensorCalibrationScreen screen in Celsius', () => {
    let component = render(
  ...
  test('Change Offset', () => {
    ...
    const OffsetWheel = component.getByTestId('OffsetWheel');
    act(() => {
