...
import ScreenAdvancedSettings from '../../src/pages/ScreenAdvancedSettings';
...
describe('ScreenAdvancedSettings screen', () => {

  beforeEach(() => {
    component = render(
      <Provider store={store}>
        <ScreenAdvancedSettings navigation={fakeNavigation} />
      </Provider>
    )
  })

  it('Render ScreenAdvancedSettings screen', () => {
    expect(component).toBeDefined();
  });

  it('Insert incorrect code', () => {
  ...
  it('Insert correct code navigate to ScreenAdvancedSettings2', () => {
    const input = component.getByTestId("CodeTextInput")
    act(() => {
      fireEvent.changeText(input, '1886');
      jest.advanceTimersByTime(100);
    })
    expect(fakeNavigation.navigate).toBeCalledWith('ScreenAdvancedSettings2')
  });
