...
import HumidityCalibration from '../../src/pages/HumidityCalibration';
...
describe('HumidityCalibration screen', () => {

  beforeEach(() => {
    component = render(
      <Provider store={store}>
        <HumidityCalibration navigation={fakeNavigation} />
      </Provider>
    )
  })

  it('Render HumidityCalibration screen', () => {
