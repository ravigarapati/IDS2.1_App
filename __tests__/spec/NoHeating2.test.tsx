...
import NoHeating2 from '../../src/pages/UnitConfiguration/NoHeating2';
...
describe('NoHeating2 screen', () => {

  beforeEach(() => {
    component = render(
      <Provider store={store}>
        <NoHeating2 navigation={fakeNavigation} />
      </Provider>
    )
  })

  it('Render NoHeating2 screen', () => {
