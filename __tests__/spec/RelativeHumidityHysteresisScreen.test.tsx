...
import RelativeHumidityHysteresisScreen from '../../src/pages/RelativeHumidityHysteresisScreen';
...
describe('RelativeHumidityHysteresisScreen screen', () => {

  beforeEach(() => {
    component = render(
      <Provider store={store}>
        <RelativeHumidityHysteresisScreen navigation={fakeNavigation} />
      </Provider>
    )
  })

  it('Render RelativeHumidityHysteresisScreen screen', () => {
    expect(component).toBeDefined();
  });

  it('Render RelativeHumidityHysteresisScreen in Celsius screen', () => {
  ...
  test('Change Relative Humidity Hysteresis', () => {
    const setAdccessSettings = jest.spyOn(
      homeOwnerActions,
      'setAdccessSettings',
    );
    const RelativeHumidityHysteresisWheel = component.getByTestId('RelativeHumidityHysteresisWheel');
    act(() => {
        fireEvent(RelativeHumidityHysteresisWheel, 'confirm');
    })
    setAdccessSettings();
  });
