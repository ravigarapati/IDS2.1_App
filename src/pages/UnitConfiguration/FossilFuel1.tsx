...
const FossilFuel1 = ({
  ...
  const navigateToFossilFuel2 = () => {
    return navigation.navigate('FossilFuel2');
  };
              ...
              {modes.map(item => {
                return (
                  <OptionText
                    ...
                    enableHint=""
                    disableHint={`${item.name}. ${item.description}`}
                  />
                );
              })}
            </View>
...
export default connect(mapStateToProps)(FossilFuel1);
